...
impl<'a, 'tcx> Visitor<'tcx> for TypeChecker<'a, 'tcx> {
    ...
    fn visit_terminator(&mut self, terminator: &Terminator<'tcx>, location: Location) {
        match &terminator.kind {
            ...
            | TerminatorKind::Return
            | TerminatorKind::Unreachable
            // We don't have any specific type-related validation for Reattach or Detach.
            // Something else should have already reasoned that our types for the assigned variables
            // are consistent, and basic blocks don't have types.
